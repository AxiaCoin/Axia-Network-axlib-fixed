...
This crate ist ported from `fixed = 0.5.4`. It has been adapted to be usable within [axlib](https://github.com/axia-tech/axlib) runtimes. Additionally, transcendental functions have been added (log, exp, pow, trigonometry).
